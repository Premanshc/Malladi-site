            ...
            <>
              ...
              <table style={{marginTop:"90px"}}>
                <thead>
                  <tr>
                    <th rowSpan={2}>Serial No</th>
                    <th colSpan={2} style={{ display: isVisible ? 'table-cell' : 'none' }}>Range</th>
                    <th rowSpan={2} style={{ display: isVisible ? 'table-cell' : 'none' }}>Calibration</th>
                    <th rowSpan={2}>Factor</th>
                    <th rowSpan={2}>Readings</th>
                    <th rowSpan={2}>Calibrated Readings</th>
                    <th rowSpan={2}>Temperature Level</th>
                  ...
                  <tr >
                    <th style={{ display: isVisible ? 'table-cell' : 'none' }}>Min</th>
                    <th style={{ display: isVisible ? 'table-cell' : 'none' }}>Max</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                  <td><input type="text" value={"R-408" || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={allTopics["AX3/02/MALLADI/1/CONFIG/MIN"] || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={allTopics["AX3/02/MALLADI/1/CONFIG/MAX"] || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={parseFloat(allTopics["AX3/02/MALLADI/1/CONFIG/CALIBRATION"]).toFixed(2) ||
                        "LOADING...."} /></td>
                  <td><input type="text" value={parseFloat(allTopics["AX3/01/MALLADI/1/CONFIG/FACTOR"]).toFixed(2) ||
                        "LOADING...."} /></td>
                    <td>
                      {parseFloat(allTopics["AX3/02/MALLADI/1/VALUE"]).toPrecision(
                        4
                      ) || "LOADING...."}  &deg;C
                    </td>
                    <td>
                      {parseFloat(
                        allTopics["AX3/02/MALLADI/1/CALIBRATED_VALUE"]
                      ).toPrecision(4) || "LOADING...."}  &deg;C
                    </td>
                    <td>
                      <meter
                        value={parseFloat(allTopics["AX3/02/MALLADI/1/CALIBRATED_VALUE"]) || 0}
                        min={allTopics["AX3/02/MALLADI/1/CONFIG/MIN"]}
                        max={allTopics["AX3/02/MALLADI/1/CONFIG/MAX"]}
                      ></meter>
                    </td>
                    <td
                      rowSpan={3}
                      style={{
                        background:
                          allTopics["AX3/02/MALLADI/STATUS"] === "Online" ? "green" : "rgb(245,106,94)",
                        color: "white",
                      }}
                    >
                      {allTopics["AX3/02/MALLADI/STATUS"] || "Loading..."}
                    </td>
                    <td
                      rowSpan={3}
                      style={{
                  ...
                  <tr>
                  <td><input type="text" value={"R-404" || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={allTopics["AX3/02/MALLADI/2/CONFIG/MIN"] || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={allTopics["AX3/02/MALLADI/2/CONFIG/MAX"] || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={parseFloat(allTopics["AX3/02/MALLADI/2/CONFIG/CALIBRATION"]).toFixed(2) ||
                        "LOADING...."} /></td>
                  <td><input type="text" value={parseFloat(allTopics["AX3/02/MALLADI/2/CONFIG/FACTOR"]).toFixed(2) ||
                        "LOADING...."} /></td>
                    <td>
                      {parseFloat(allTopics["AX3/02/MALLADI/2/VALUE"]).toPrecision(
                        4
                      ) || "LOADING...."}  &deg;C
                    </td>
                    <td>
                      {parseFloat(
                        allTopics["AX3/02/MALLADI/2/CALIBRATED_VALUE"]
                      ).toPrecision(4) || "LOADING...."}  &deg;C
                    </td>
                    <td>
                      <meter
                        value={parseFloat(allTopics["AX3/02/MALLADI/2/VALUE"]) || 0}
                        min={allTopics["AX3/02/MALLADI/2/CONFIG/MIN"]}
                        max={allTopics["AX3/02/MALLADI/2/CONFIG/MAX"]}
                      ></meter>
                    </td>
                  </tr>
                  ...
                  <tr>
                  <td><input type="text" value={"R-403" || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={allTopics["AX3/02/MALLADI/3/CONFIG/MIN"] || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={allTopics["AX3/02/MALLADI/3/CONFIG/MAX"] || "LOADING.."} /></td>
                  <td style={{ display: isVisible ? 'table-cell' : 'none' }}><input type="text" value={parseFloat(allTopics["AX3/02/MALLADI/2/CONFIG/CALIBRATION"]).toFixed(2) || "LOADING...."} /></td>
                  <td><input type="text" value={parseFloat(allTopics["AX3/01/MALLADI/2/CONFIG/FACTOR"]).toFixed(2) || "LOADING...."} /></td>
                    <td>
                      {parseFloat(allTopics["AX3/02/MALLADI/2/VALUE"]).toPrecision(
                        4
                    ...
                    <td>
                      <meter
                        value={parseFloat(allTopics["AX3/02/MALLADI/2/VALUE"]) || 0}
                        min={allTopics["AX3/02/MALLADI/3/CONFIG/MIN"]}
                        max={allTopics["AX3/02/MALLADI/3/CONFIG/MAX"]}
                      ></meter>
                    </td>
                  </tr>
                </tbody>
